...
<div class="row " >
    <div class="col-md-12">
        <div class="block">
            ...
            <!-- Normal Form Content -->
            <form action="{{route('admin.admins.store')}}" method="POST" class="form-horizontal form-bordered">
                @csrf
                <div class="form-group">
                    ...
                    <div class="col-xs-3">
                        ...
                        <input type="text" id="ocupacion" name="ocupacion" class="form-control" placeholder="Ocupación">
